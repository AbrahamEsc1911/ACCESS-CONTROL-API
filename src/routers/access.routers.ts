...
import { createNewReservation, deleteReservation, getAllReservationsById, updateReservation, userAccess } from "../controllers/access.controller";

const router = Router()

router.get('/availability/:id', auth, getAllReservationsById)
router.post('/reservation/:roomId', auth, createNewReservation)
router.post('/:roomId', auth, userAccess )
